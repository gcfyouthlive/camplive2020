...
function Instructions() {
  return (
    <Container className="instructions-container">
      ...
      Step 1: Fill up this form <br />
      Step 2: Do this other thing <br />
      Step 3: Check this other thing <br />
      Step 4: Pay
    </Container>
  );
}
...
function RegForm() {
  return (
      <Form>
        <Form.Row>
          <Col sm={12}><CampFormInput controlId="email" label="Email" type="email" placeholder="Email address" /></Col>
        </Form.Row>
        <Form.Row>
        ...
        <Form.Row>
          ...
          <Col sm={6}><CampFormInput controlId="facebook_id" label="Facebook ID" type="text" /></Col>
        </Form.Row>
        <Form.Row>
...
export default function CampReg() {
  return (
    <Container fluid={true} className="campreg-container">
      <Row>
        <Col xs={12} sm={6}>
          <Instructions />
        </Col>
